---@class GiftPack_Common_Get_FX_UIBP_C:UUserWidget
...
--Edit Below--
local GiftPack_Common_Get_FX_UIBP = { bInitDoOnce = false } 

function GiftPack_Common_Get_FX_UIBP:Construct()
	
end


-- function GiftPack_Common_Get_FX_UIBP:Tick(MyGeometry, InDeltaTime)

-- end

-- function GiftPack_Common_Get_FX_UIBP:Destruct()

-- end

function GiftPack_Common_Get_FX_UIBP:InitUI(ItemID, ItemNum)
    local ItemInfo = Common.GetObjectDatas()[ItemID];
    if ItemInfo then
...
return GiftPack_Common_Get_FX_UIBP