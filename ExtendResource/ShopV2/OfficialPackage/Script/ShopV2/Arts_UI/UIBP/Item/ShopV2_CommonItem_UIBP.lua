...
function ShopV2_CommonItem_UIBP:Refresh(ProductID)
    ...
    if ProductData == nil then
        print("ShopV2_CommonItem_UIBP:Refresh ProductData is nil for " .. tostring(ProductID));
        return;
    end

    local ItemData = ShopV2Manager:GetItemConfigData(ProductData.ItemID);
    if ItemData == nil then
        print("ShopV2_CommonItem_UIBP:Refresh ItemData is nil for ItemID " .. tostring(ProductData.ItemID));
        return;
    end
...
function ShopV2_CommonItem_UIBP:OnItemButtonClick()
    print("[ShopDiag] CommonItem click ProductID=" .. tostring(self.ProductID))
