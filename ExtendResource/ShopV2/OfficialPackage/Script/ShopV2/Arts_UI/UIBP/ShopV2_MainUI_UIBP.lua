...
---@field Tabs ULuaArrayHelper<FShopV2_TabInfo__pf1997697089>
...
function ShopV2_MainUI_UIBP:ShowPurchasePanel(ProductID)
    if self.PurchasePanel == nil then
        print("ShopV2_MainUI_UIBP:ShowPurchasePanel PurchasePanel is nil");
        return;
    end
...
function ShopV2_MainUI_UIBP:ShowPurchaseTip(Message)
    if self.PurchaseTipUI == nil then
        print("ShopV2_MainUI_UIBP:ShowPurchaseTip PurchaseTipUI is nil");
        return;
    end
...
function ShopV2_MainUI_UIBP:ShowItemGet(ItemID, Num)
    if self.ItemGetUI == nil then
        print("ShopV2_MainUI_UIBP:ShowItemGet ItemGetUI is nil");
        return;
    end
