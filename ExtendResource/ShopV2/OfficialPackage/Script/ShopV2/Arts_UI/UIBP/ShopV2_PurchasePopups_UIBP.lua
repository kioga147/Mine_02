...
function ShopV2_PurchasePopups_UIBP:Refresh(ProductID)
    ...
    if self.ProductData == nil then
        print("ShopV2_PurchasePopups_UIBP:Refresh ProductData is nil for " .. tostring(ProductID));
        return;
    end
    local ItemData = ShopV2Manager:GetItemConfigData(self.ProductData.ItemID);
    if ItemData == nil then
        print("ShopV2_PurchasePopups_UIBP:Refresh ItemData is nil for ItemID " .. tostring(self.ProductData.ItemID));
        return;
    end
