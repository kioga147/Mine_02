...
--Edit Below--
local UGC_Task_Get_FX_UIBP = { bInitDoOnce = false } 

function UGC_Task_Get_FX_UIBP:Construct()
	
end


-- function UGC_Task_Get_FX_UIBP:Tick(MyGeometry, InDeltaTime)

-- end

-- function UGC_Task_Get_FX_UIBP:Destruct()

-- end

function UGC_Task_Get_FX_UIBP:InitUI(ItemID, ItemNum)
