---@class Copper_mine_C:BP_UGC_DamagableActor_C
...
function Copper_mine:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
function Copper_mine:GetReplicatedProperties()
    return 'ShakeSpeed', 'ShakeAmplitude'
end

function Copper_mine:ReceiveTick(DeltaTime)
...
function Copper_mine:BPDie(KillingDamage, EventInstigator,DamageCauser,DamageEvent,DamageTypeID)
