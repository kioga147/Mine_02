---@class Gif_01_C:BP_UGC_DamagableActor_C
...
function Gif_01:ReceiveBeginPlay()
    self.ShakeTime = 0
...
function Gif_01:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
function Gif_01:GetReplicatedProperties()
    return 'ShakeSpeed', 'ShakeAmplitude'
end

function Gif_01:ReceiveTick(DeltaTime)
...
function Gif_01:BPDie(KillingDamage, EventInstigator,DamageCauser,DamageEvent,DamageTypeID)
