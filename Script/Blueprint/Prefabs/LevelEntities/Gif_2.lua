---@class Gif_2_C:BP_UGC_DamagableActor_C
...
function Gif_2:ReceiveBeginPlay()
    self.ShakeTime = 0
...
function Gif_2:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
function Gif_2:GetReplicatedProperties()
    return 'ShakeSpeed', 'ShakeAmplitude'
end

function Gif_2:ReceiveTick(DeltaTime)
...
function Gif_2:BPDie(KillingDamage, EventInstigator,DamageCauser,DamageEvent,DamageTypeID)
