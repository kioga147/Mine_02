---@class Ruby_mine_C:BP_UGC_DamagableActor_C
...
function Ruby_mine:ReceiveBeginPlay()
    ...
    if MineZoneManager and UGCGameSystem.IsServer() then
        MineZoneManager.RegisterOre(self, "RubyOre")
    end
end

function Ruby_mine:PreOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
...
function Ruby_mine:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
function Ruby_mine:GetReplicatedProperties()
    return 'ShakeSpeed', 'ShakeAmplitude'
end

function Ruby_mine:ReceiveTick(DeltaTime)
