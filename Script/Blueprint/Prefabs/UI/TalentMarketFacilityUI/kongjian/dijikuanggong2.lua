---@class dijikuanggong2_C:UUserWidget
...
local dijikuanggong2 = { bInitDoOnce = false; }; 

function dijikuanggong2:Construct()
	
end

function dijikuanggong2:Reset()

    self.PurchaseLimitInfo:SetVisibility(ESlateVisibility.Collapsed);
end

function dijikuanggong2:Refresh(ProductID)
