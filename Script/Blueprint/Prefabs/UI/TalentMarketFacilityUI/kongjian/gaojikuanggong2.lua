---@class gaojikuanggong2_C:UUserWidget
...
local gaojikuanggong2 = { bInitDoOnce = false; }; 

function gaojikuanggong2:Construct()
	
end

function gaojikuanggong2:Reset()

    self.PurchaseLimitInfo:SetVisibility(ESlateVisibility.Collapsed);
end

function gaojikuanggong2:Refresh(ProductID)
