...
do
    ...
    if Ok and type(Mod) == "table" then
        ...
        MineTeleportConfig = {
            ...
            TeleportCost = 3000,
            Zones = {
                [1] = { Name = "石滩", PadX = 21670.898438, PadY = 7234.638672, PadZ = 124.259644 },
                [2] = { Name = "煤矿场", PadX = 37576.707031, PadY = 7152.552734, PadZ = 124.240067 },
                [3] = { Name = "黄铜矿脉", PadX = 41571.179688, PadY = 32947.742188, PadZ = 124.224442 },
                [4] = { Name = "深层矿区", PadX = 36463.558594, PadY = 46880.234375, PadZ = 124.236160 },
                [5] = { Name = "宝石矿区", PadX = 13395.021484, PadY = 51551.093750, PadZ = 124.224442 },
            },
...
"Server_RequestJadeCollectionSync", "Server_PlaceRawJadeInCollection",
        ...
        "Server_SetAutoMineFactoryWorker", "Server_ToggleAutoMineFactoryKeepJade", "Server_SwitchTitle"
end
...
function UGCPlayerController:GetAvailableClientRPCs()
    return "Client_OpenJadeAppraisal", "Client_CloseJadeAppraisal",
        ...
        "Client_AutoMineFactoryWorkerSync", "Client_TitleNotify", "Client_EnsureTitleBarAdded", "Client_EnsureAllTitleBars", "Client_SyncTitleState"
end
