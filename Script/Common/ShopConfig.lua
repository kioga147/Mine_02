...
local ShopConfig = {
    ...
    Tools = {
        ...
        [5]  = { ItemId = 8310025, Name = "合金镐",       Range = 1,  Damage = 4,   MineLevel = 3, Cost = 6000 },
        [6]  = { ItemId = 8310028, Name = "合金钻头",     Range = 5,  Damage = 4,   MineLevel = 3, Cost = 20000 },
        ...
        [9]  = { ItemId = 8310024, Name = "强化钻石镐",   Range = 1,  Damage = 100, MineLevel = 5, Cost = 30000 },
        [10] = { ItemId = 8310020, Name = "强化钻石钻头", Range = 9,  Damage = 100, MineLevel = 5, Cost = 100000 },
        [11] = { ItemId = 8310023, Name = "初级采矿车",   Range = "3x3", Damage = 100, MineLevel = 2, Cost = 25000 },
        [12] = { ItemId = 8310021, Name = "中级采矿车",   Range = "5x5", Damage = 100, MineLevel = 4, Cost = 150000 },
        [13] = { ItemId = 8310029, Name = "高级采矿车",   Range = "7x7", Damage = 100, MineLevel = 5, Cost = 300000 },
    },
